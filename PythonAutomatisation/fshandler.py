...
DELING_PATH = os.path.join("Ressources", "ArchiveManagementCLI")
...
def unpack(source_path, dest_path):
    ...
    subprocess.run(["Ressources/ArchiveManagementCLI/deling-cli.exe", "export", os.path.join(source_path, "battle.fs"), dest_path])
